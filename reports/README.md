...
The scheduled trading task must explicitly read `AGENTS.md`, `STRATEGY.md`, and `AUTOMATION.md`. A separate weekly
reporting schedule must be created before weekly reports will be generated automatically.
